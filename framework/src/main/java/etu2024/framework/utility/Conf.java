...
public class Conf {
  ...
  static Document getDocument() {
    try {
      ...
      throw new RuntimeException(
          "Error while parsing app.xml config, verify path or syntax");
    }
  }
  ...
  public static String getAuthSessionName() {
    try {
      Element sessionElement =
          (Element)getDocument().getElementsByTagName("session").item(0);
  ...
  public static HashMap<String, String> getAuthProfiles() {
    try {
      Element profilesElement =
          (Element)getDocument().getElementsByTagName("profiles").item(0);
  ...
  public static HashMap<String, String> getAuthRedirections() {
    try {
      Element redirectionsElement =
          (Element)getDocument().getElementsByTagName("redirections").item(0);
      NodeList redirectionNodes =
          redirectionsElement.getElementsByTagName("redirect");
