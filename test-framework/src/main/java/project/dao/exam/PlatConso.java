...
public class PlatConso extends GenericDAO {
  ...
  public PlatConso(LocalDate localDate, String platId, String empId,
                   String file) {
  ...
  public void save() throws SQLException, InvocationTargetException,
  ...
  public List<PlatConsoView> getAll()
    ...
    for (Object platconso : platconsos) {
      ...
      platConsoView.setPlat(
          ((Plat) new Plat().getById(dbConnection, act.getPlatId()))
              .getLibelle());
