...
public class PlatConsoController {
  ...
  public ModelView insertion()
    ...
    if (getFile() != null & getDate() != null & getPlat_id() != null &
        getEmp_id() != null) {
      getFile().uploadToFile(
          "/Users/mendrika/IdeaProjects/S4-Java-Framework/test-framework/src/main/webapp/upload/");
      PlatConso platConso = new PlatConso(getDate(), getPlat_id(), getEmp_id(),
                                          getFile().getName());
      platConso.save();
  ...
  public ModelView liste()
      throws SQLException, InvocationTargetException, NoSuchMethodException,
             ...
             NotIdentifiedInDatabaseException {
  ...
  public String getPlat_id() { return plat_id; }

  public void setPlat_id(String plat_id) { this.plat_id = plat_id; }
